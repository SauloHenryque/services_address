package br.com.saulo.address.ultil;
...
public class GenericConvert {
   ...
   public static <E, T> List<E> convertModelMapper(List<T> source, Type destinationType, MatchingStrategy strategy) {
    ...
    public static <T, E> PageAddress convertModelMapperToPage(Page<T> page, Type typeDestination) {
    ...
    public static PageAddress buildPageLoja(Page p) {
        ...
        if (p == null) {
        	 ...
        	 PageAddress pageApi = new PageAddress();
