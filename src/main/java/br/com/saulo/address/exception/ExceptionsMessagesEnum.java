...
package br.com.saulo.address.exception;
...
import br.com.saulo.address.ultil.I18n;
...
public enum ExceptionsMessagesEnum {
	...
	ORDER_REEMBOLSO_NAO_ENCONTRADO(NOT_FOUND.value(), "order_reembolso_nao_encontrado", NotFoundException.class)
